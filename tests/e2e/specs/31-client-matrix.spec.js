...
// Wrapper functions for backward compatibility with existing test code
async function ensureIdentity(page, name) {
  return ensureIdentityExists(page, name);
}
