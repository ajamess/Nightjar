                            ...
                            <div className="section">
                                ...
                                <div className="about-info">
                                    <p>
                                        ...
                                        {' '}
                                        <a 
                                            href="https://github.com/ajamess/Nightjar" 
                                            target="_blank" 
                                    ...
                                    <p className="section-hint">
                                        ...
                                        {isElectron ? (
                                            <>
                                                <a 
                                                    href={`https://github.com/ajamess/Nightjar/releases/tag/v${window.electronAPI?.appVersion || '1.0.0'}`}
                                                    target="_blank"
                                                    rel="noopener noreferrer"
                                                    className="version-link"
                                                >
                                                    {window.electronAPI?.appVersion || '1.0.0'}
                                                </a>
                                                {' · '}
                                                <a 
                                                    href="https://github.com/ajamess/Nightjar/releases"
                                                    target="_blank"
                                                    rel="noopener noreferrer"
